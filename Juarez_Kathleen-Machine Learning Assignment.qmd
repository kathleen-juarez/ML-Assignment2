...
```{r}
#remove.packages("earth")
# (Optional) also remove related helpers if installed:
# remove.packages(c("plotmo","plotrix"))

# Prefer exact-match binary for your R version:
#install.packages("earth")  # will fetch the correct binary for 4.4.x

install.packages("earth", type = "source", Ncpus = parallel::detectCores())
